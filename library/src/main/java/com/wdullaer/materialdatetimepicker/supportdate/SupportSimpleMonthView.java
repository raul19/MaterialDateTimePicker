...
public class SupportSimpleMonthView extends SupportMonthView {

    public SupportSimpleMonthView(Context context, AttributeSet attr, SupportDatePickerController controller) {
