...
public class SupportDatePickerDialog extends DialogFragment implements
        View.OnClickListener, SupportDatePickerController {
    ...
    private SupportDayPickerView mDayPickerView;
    private SupportYearPickerView mYearPickerView;
     ...
     */
    public static SupportDatePickerDialog newInstance(OnDateSetListener callBack, int year,
                                                                                        int monthOfYear,
                                                                                        int dayOfMonth) {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        final Activity activity = getActivity();
        mDayPickerView = new SupportSimpleDayPickerView(activity, this);
        mYearPickerView = new SupportYearPickerView(activity, this);
    ...
    public SupportMonthAdapter.CalendarDay getSelectedDay() {
        return new SupportMonthAdapter.CalendarDay(mCalendar, getTimeZone());
    }
    ...
    public void notifyOnDateListener() {
        if (mCallBack != null) {
            mCallBack.onDateSet(SupportDatePickerDialog.this, mCalendar.get(Calendar.YEAR),
