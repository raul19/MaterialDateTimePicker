...
public class SupportYearPickerView extends ListView implements AdapterView.OnItemClickListener, SupportDatePickerDialog.OnDateChangedListener {
    private static final String TAG = "YearPickerView";

    private final SupportDatePickerController mController;
    private YearAdapter mAdapter;
    private int mViewSize;
    private int mChildSize;
    private TextViewWithCircularIndicator mSelectedView;

    public SupportYearPickerView(Context context, SupportDatePickerController controller) {
        super(context);
